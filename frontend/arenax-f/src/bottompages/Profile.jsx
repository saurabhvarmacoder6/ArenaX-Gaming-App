            ...
            <div className="min-h-screen bg-[#09090B] text-white px-4 py-6">
                <div className="mx-auto p-4 pb-40">
                    ...
                    <motion.button
                        ...
                        className=" mt-8 flex w-full items-center justify-center gap-3 rounded-2xl bg-linear-to-r from-red-500 to-red-600 py-4 font-semibold shadow-[0_10px_30px_rgba(239,68,68,.35)]"
                    >
                        <FiLogOut size={20} />
                        Logout
                    </motion.button>
